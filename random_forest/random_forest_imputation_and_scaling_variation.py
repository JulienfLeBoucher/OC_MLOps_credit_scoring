# Script objective:
# 
# Now that I discovered SMOTE did not help and that one hot encoded
# categorical was the best, I want to evaluate the impact of the
# scaling and imputation methods.
#
...
experiment_name = 'random_forest_imputation_and_scaling_variation'
